        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a class="btn btn-lg ws-btn wow fadeInUpBig text-white" href="{{route('product-grids')}}" role="button">View More<i class="far fa-arrow-alt-circle-right"></i></i></a>
...
<section class="midium-banner mt-4 mb-5">
    <div class="container">
        <div class="row">
            @if($featured)
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="price with-discount mt-2"> <span class="old">${{number_format($product->price,2)}}</span>
                                    @php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    @endphp
                                    <span>${{number_format($after_discount,2)}}</span></p>
                                    </div>
                                </div>
