...
@section('title','Ghousia  || Terms & Conditions')
...
@section('main-content')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html">Terms & Conditions</a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<section class="about-us section">
		<div class="container">
			<div>
				<h1 class="mb-4 heading-title">TERMS & CONDITIONS</h1>
				<p class="common-para">
					This website is operated by Ghausia. Throughout the site, the terms “we”, “us” and “our” refer to Ghausia. ShaPosh offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
