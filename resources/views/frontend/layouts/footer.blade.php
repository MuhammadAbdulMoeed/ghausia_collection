        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-footer links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('exchange-refund')}}">Exchange & Refunds</a></li>
                ...
                {{--            <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <div class="shop-newsletter section p-0">
        ...
        <div class="inner pt-4 pb-4">
            <div class="row">
                ...
                {{--						<div class="col-lg-4 col-12">
                                            ...
                                            <li><a href="#"><img src="{{asset('backend/img/2.png')}}" alt="" width="50"/></a></li>
                                            <li><a href="#"><img src="{{asset('backend/img/3.png')}}" alt="" width="50"/></a></li>
                                            <li><a href="#"><img src="{{asset('backend/img/4.png')}}" alt="" width="50"/></a></li>
                                            <li><a href="#"><img src="{{asset('backend/img/5.png')}}" alt="" width="50"/></a></li>
                                            <li><a href="#"><img src="{{asset('backend/img/6.png')}}" alt="" width="50"/></a></li>
                                        </ul>
